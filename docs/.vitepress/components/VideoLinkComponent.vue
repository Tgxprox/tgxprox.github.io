<template>
  ...
  <div class="iframe-box">
    <!-- 动态组件渲染 -->
    <iframe v-if="props.type === 'IP代理'"  width="688" height="385" src="https://www.youtube.com/embed/fIC80UXcbjQ?si=mSAg5Yr7UG9eseOI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    ...
    <iframe v-if="props.type === '群组监听'"  width="688" height="385" src="https://www.youtube.com/embed/sYhMnjvESZU?si=uJ028XTkBez7jqow" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
